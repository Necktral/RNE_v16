# runtime/legacy/infrastructure.py  [LEGACY cuarentena — ver runtime/legacy/README.md]
...
# `Event` se extrajo a runtime/core/events.py (lo usa código vivo).
from runtime.core.events import Event  # noqa: F401 — re-export de compatibilidad
