...
- 2026-07-10: Obsidian Mind installed inside RNFE v16 at `ai/obsidian-mind/`; root agent files now point Codex, Claude Code, and Gemini CLI to the shared vault. See [[RNFE v16 Project Memory]].
