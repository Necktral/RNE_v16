...
from runtime.reasoning.external_models.guard import (
    GuardDecision,
...
# B15: GuardDecision y guard_external_choice viven en su hogar canónico
# (runtime/reasoning/external_models/guard.py) y se importan arriba; la copia
# local duplicada fue eliminada.
